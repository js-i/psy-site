export const helpTopics = [
  {
    ...
    seoName: "КПТ-консультации при тревоге онлайн",
    seoDescription:
      "КПТ-консультации при тревоге: работа с мыслями и привычками, которые её поддерживают.",
  },
  {
    id: "panic-attacks",
    ...
    seoName: "Консультации при панических атаках онлайн",
    seoDescription:
